              ...
              <div className="pt-5 w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/2">
                ...
                <div className="container mx-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 overflow-auto">
                    <ReposCard name={"BulkyBeastSite"} link={"https://github.com/yaibrahim/BulkyBeastSIte"}>
                      <span className="inline-block bg-red-100 text-red-800 text-xs px-2 py-1 rounded">
                        HTML
                      </span>
                    </ReposCard>

                    <ReposCard name={"eCommercioProject"} link={"https://github.com/yaibrahim/eCommercioProject"}>
                    ...
                    <ReposCard name={"at_your_doorstep-Ya_Ibrahim"} link={"https://github.com/atyourdoorstep/at_your_doorstep-Ya_Ibrahim"}>
                    ...
                    <ReposCard name={"work-shift-planning"} link="https://github.com/yaibrahim/work-shift-planning">
                      <p className="text-gray-700 mb-2 text-xs">
                      Build a REST application from scratch that could serve as a work planning service. 
                      Business requirements: A worker has shifts A shift is 8 hours long A worker never has two shifts on the same day It is a 24 hour timetable 0-8, 8-16, 16-24.
                      </p>
                      <span className="inline-block bg-red-200 text-red-800 text-xs px-2 py-1 rounded">
                        Ruby
                      </span>
                    ...
                    <ReposCard name={"yaibrahim"} link={"https://github.com/yaibrahim/yaibrahim"}>
                      <p className="text-gray-700 mb-2 text-xs">
                    ...
                    <ReposCard name={"github-clone-react"} link={"https://github.com/yaibrahim/github-clone-react"}>
